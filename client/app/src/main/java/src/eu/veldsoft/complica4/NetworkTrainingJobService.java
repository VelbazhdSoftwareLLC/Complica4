 ...
 */
public class NetworkTrainingJobService extends JobService {
	/**
	...
	private void setupAlarm() {
		...
		try {
			interval = getPackageManager().getServiceInfo(
					new ComponentName(NetworkTrainingJobService.this, NetworkTrainingJobService.this.getClass()),
	...
	private double obtainRemoveBestError() {
		String host = "";
		try {
			host = getPackageManager().getApplicationInfo(NetworkTrainingJobService.this.getPackageName(),
	 ...
	 * Service constructor.
	 */
	public NetworkTrainingJobService() {
		super();
	}
	...
	public void onCreate() {
		...
		if (helper == null) {
			helper = new MovesHistoryDatabaseHelper(NetworkTrainingJobService.this);
		}
	}
